 ...
 * generated in the com.example.ws.server3.services package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetUserInfoResponse_QNAME = new QName("http://services.server3.ws.example.com/", "getUserInfoResponse");
    private final static QName _GetUserInfo_QNAME = new QName("http://services.server3.ws.example.com/", "getUserInfo");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.example.ws.server3.services
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://services.server3.ws.example.com/", name = "getUserInfoResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://services.server3.ws.example.com/", name = "getUserInfo")
