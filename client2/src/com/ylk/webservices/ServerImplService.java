 ...
 * 
 */
@WebServiceClient(name = "ServerImplService", targetNamespace = "http://webservices.ylk.com/", wsdlLocation = "http://localhost:8080/calculate?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SERVERIMPLSERVICE_QNAME = new QName("http://webservices.ylk.com/", "ServerImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/calculate?wsdl");
    ...
    public ServerImpl getServerImplPort() {
        return super.getPort(new QName("http://webservices.ylk.com/", "ServerImplPort"), ServerImpl.class);
    }
     ...
     */
    @WebEndpoint(name = "ServerImplPort")
    public ServerImpl getServerImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservices.ylk.com/", "ServerImplPort"), ServerImpl.class, features);
    }
